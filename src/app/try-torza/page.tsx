    ...
    <div style={{ 
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 24px' }}>
          <h1 style={{ fontSize: 'clamp(2.25rem, 5vw, 3.25rem)', fontWeight: 800, color: '#0b1020', marginBottom: 12, lineHeight: 1.1 }}>Try Torza checkout</h1>
          <div style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)', fontWeight: 900, color: '#ea580c', marginBottom: 12 }}>in a live environment</div>
          <p style={{
            fontSize: 16,
            color: '#374151',
            maxWidth: 720,
